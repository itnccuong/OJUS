        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let index = 0; index < testcaseLength; ++index) {
                const result = yield (0, executor_utils_1.executeAgainstTestcase)(filename, executor_utils_1.languageDetails[language].inputFunction
                    ? executor_utils_1.languageDetails[language].inputFunction(testcases.input[index])
                    : testcases.input[index], testcases.output[index], language, timeLimit);
...
], SubmissionController.prototype, "submit", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SubmissionController.prototype, "getAllProblemsNoAccount", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SubmissionController.prototype, "getAllProblemsWithAccount", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SubmissionController.prototype, "getOneProblemNoAccount", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SubmissionController.prototype, "getOneProblemWithAccount", null);

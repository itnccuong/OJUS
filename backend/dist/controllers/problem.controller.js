...
let SubmissionController = class SubmissionController extends tsoa_1.Controller {
  submit(problem_id, body, req, CompileErrorResponse, FailTestResponse) {
    return __awaiter(this, void 0, void 0, function* () {
      const { code, language } = body;
      const userId = req.userId;
      // Step 1: Create submission record
      let submission = yield (0, submit_services_1.createSubmission)(
        problem_id,
        userId,
        code,
        language,
      ...
      let filename = (0, submit_services_1.saveCodeToFile)(
        submission.submissionId,
        code,
        language,
      );
      // Step 4: Compile code
      const compileResult = yield (0, executor_utils_1.compile)(
        filename,
        language,
      );
      if (compileResult.stderr) {
        submission = yield (0, submit_services_1.updateSubmissionVerdict)(
          submission.submissionId,
          "COMPILE_ERROR",
        );
      ...
      for (let index = 0; index < testcaseLength; ++index) {
        const result = yield (0, executor_utils_1.executeAgainstTestcase)(
          filename,
          executor_utils_1.languageDetails[language].inputFunction
            ? executor_utils_1.languageDetails[language].inputFunction(
        ...
        yield (0, submit_services_1.createResult)(
          submission.submissionId,
          index,
          result.stdout,
          result.verdict,
  ...
  getAllProblemsWithAccount(req) {
    return __awaiter(this, void 0, void 0, function* () {
      const userId = req.userId;
      const responseData = yield (0, problem_service_1.queryProblemStatus)(
        userId,
      );
      return {
  ...
  getOneProblemNoAccount(problem_id) {
    return __awaiter(this, void 0, void 0, function* () {
      const problem = yield (0, submit_services_1.findProblemById)(problem_id);
      const resProblem = Object.assign(Object.assign({}, problem), {
        userStatus: false,
      });
      return {
  ...
  getOneProblemWithAccount(problem_id, req) {
    return __awaiter(this, void 0, void 0, function* () {
      const userId = req.userId;
      const problem = yield (0, submit_services_1.findProblemById)(problem_id);
      const userStatus = yield (0, problem_service_1.getUserStatus)(
        userId,
        problem.problemId,
      );
      const resProblem = Object.assign(Object.assign({}, problem), {
...
__decorate(
  [
    ...
    // @Security("jwt")
    (0, tsoa_1.Middlewares)(verify_token_1.verifyToken),
    (0, tsoa_1.SuccessResponse)(
      200,
      "Successfully fetched all problems with account",
    ),
...
__decorate(
  [
    ...
    (0, tsoa_1.SuccessResponse)(
      200,
      "Successfully fetched problem without user data",
    ),
    __param(0, (0, tsoa_1.Path)()),
    __metadata("design:type", Function),
...
__decorate(
  [
    ...
    (0, tsoa_1.SuccessResponse)(
      200,
      "Successfully fetched problem with user data",
    ),
    __param(0, (0, tsoa_1.Path)()),
...
exports.SubmissionController = SubmissionController = __decorate(
  [
    (0, tsoa_1.Route)("/src/problems"), // Base path for submission-related routes

...
const password_services_1 = require("../services/auth.services/password.services");
let AuthController = class AuthController extends tsoa_1.Controller {
    ...
    sendResetLink(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield (0, password_services_1.fineUserByEmail)(email);
            ...
            yield (0, password_services_1.sendEmail)(email, resetLink);
    ...
    changePassword(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decodedToken = (0, password_services_1.decodeResetToken)(token);
            const email = decodedToken.email;
            // Check if the user exists
            yield (0, password_services_1.fineUserByEmail)(email);

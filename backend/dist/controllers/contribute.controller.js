...
const contribution_services_1 = require("../services/problem.services/contribution.services");
let ContributionController = class ContributionController extends tsoa_1.Controller {
  submitContribute(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const etags = yield (0, uploadFile_service_1.uploadToS3)(
        file,
        details.chunk_size,
        details.urls,
      );
      // Step 3: Complete file upload and get the file URL
      const url = yield (0, uploadFile_service_1.completeUpload)(
        details.key,
        details.upload_id,
        etags,
      );
  ...
  getAllContribute() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const contributions = yield (0,
      contribution_services_1.findAllPendingContributions)();
  ...
  getOneContribute(contribute_id) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const contribution = yield (0,
      contribution_services_1.findPendingContribution)(contribute_id);
  ...
  acceptContribution(contribute_id) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield (0, contribution_services_1.findPendingContribution)(contribute_id);
...
exports.ContributionController = ContributionController = __decorate(
  [
    (0, tsoa_1.Route)("/src/contributions"), // Base path for contribution-related routes

...
let ContributionController = class ContributionController extends tsoa_1.Controller {
    ...
    getAllContribute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contributions = yield (0, contribution_services_1.findAllPendingContributions)();
    ...
    getOneContribute(contribute_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contribution = yield (0, contribution_services_1.findPendingContribution)(contribute_id);

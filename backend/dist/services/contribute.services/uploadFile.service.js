...
const startUpload = (file) => __awaiter(void 0, void 0, void 0, function* () {
...
const uploadChunk = (url, chunk) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const uploadToS3 = (file, chunkSize, urls) => __awaiter(void 0, void 0, void 0, function* () {
    const etags = [];
...
const completeUpload = (key, upload_id, etags) => __awaiter(void 0, void 0, void 0, function* () {
    const client = new client_s3_1.S3Client({
        region: process.env.AWS_DEFAULT_REGION,
        credentials: {
            accessKeyId: process.env.AWS_ACCESS_KEY_ID || "",
